...
class OrderDetailsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final displayTitle = isSingleProduct
        ...
        : '${order.items.length} Products'; // عرض عدد المنتجات بدلاً من اسم واحد
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          children: [
            ...
            _buildDetailRow(
              'Order Date',
              DateConverter.localDateToIsoStringAMPMOrder(order.createdAt),
            ...
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Icon(Icons.info_outline_rounded, size: 19, color: kMuted),
