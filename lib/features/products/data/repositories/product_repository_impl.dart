...
class ProductRepositoryImpl implements ProductRepository {
  final List<ProductEntity> _sample = const [
    ...
    ProductEntity(
      ...
      images: [ImagesConstants.goldenOrangeFreshwaterFish, ImagesConstants.goldenOrangeFreshwaterFish, ImagesConstants.goldenOrangeFreshwaterFish],
      rating: 4.3,
      reviewCount: 41,
      inWishlist: true,
      currentStock: 12,
    ...
    ProductEntity(
      ...
      images: [ImagesConstants.blueTang, ImagesConstants.blueTang, ImagesConstants.blueTang],
      rating: 4.8,
      reviewCount: 120,
      inWishlist: false,
      currentStock: 6,
    ...
    ProductEntity(
      ...
      images: [ImagesConstants.vibrantYellowOrangeFish, ImagesConstants.vibrantYellowOrangeFish, ImagesConstants.vibrantYellowOrangeFish],
      rating: 4.2,
      reviewCount: 18,
      inWishlist: false,
      currentStock: 30,
    ...
    ProductEntity(
      ...
      images: [ImagesConstants.goldenFishProfile, ImagesConstants.goldenFishProfile, ImagesConstants.goldenFishProfile],
      rating: 4.5,
      reviewCount: 54,
      inWishlist: true,
      currentStock: 8,
    ...
    ProductEntity(
      ...
      images: [ImagesConstants.freshBassWhiteBg, ImagesConstants.freshBassWhiteBg, ImagesConstants.freshBassWhiteBg],
      rating: 4.1,
      reviewCount: 21,
      inWishlist: false,
      currentStock: 14,
